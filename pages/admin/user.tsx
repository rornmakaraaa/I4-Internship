            ...
            <div className="project-container flex">
                ...
                <div className="main flex-grow p-5">
                    ...
                    <div className="flex items-center justify-between mb-4">
                        <button className="bg-blue-900 text-white font-semibold py-2 px-2 hover:bg-gray-500 rounded-lg">All Users</button>
                        <div className="flex items-center ml-4">
                            ...
                            <Link href="/admin/adduser" className="bg-blue-900 text-white font-semibold hover:bg-gray-500 rounded-lg py-2 px-4 ml-4">
                                <FaUserPlus className="inline mr-1" />Add User
                            </Link>
                        </div>
                    </div>
